		...
		// flat and wide flat calculations
		{
			...
			res_p = _mm_srli_epi16(
					_mm_add_epi16(pixetFilter_p2p1p0,
							_mm_add_epi16(p3_16, p0_16)),
					3);
			res_q = _mm_srli_epi16(
					_mm_add_epi16(pixetFilter_p2p1p0,
							_mm_add_epi16(q3_16, q0_16)),
					3);
			...
			res_p = _mm_srli_epi16(
					_mm_add_epi16(pixetFilter_p2p1p0,
							_mm_add_epi16(sum_p3, p1_16)),
					3);
			res_q = _mm_srli_epi16(
					_mm_add_epi16(pixetFilter_q2q1q0,
							_mm_add_epi16(sum_q3, q1_16)),
					3);
			...
			res_p = _mm_srli_epi16(
					_mm_add_epi16(pixetFilter_p2p1p0,
							_mm_add_epi16(sum_p3, p2_16)),
					3);
			res_q = _mm_srli_epi16(
					_mm_add_epi16(pixetFilter_q2q1q0,
							_mm_add_epi16(sum_q3, q2_16)),
					3);
		...
		// flat and wide flat calculations
		{
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(p256_7, p256_0)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(q256_7, q256_0)),
					4);
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(sum_p7, p256_1)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_q,
							_mm256_add_epi16(sum_q7, q256_1)),
					4);
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(sum_p7, p256_2)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_q,
							_mm256_add_epi16(sum_q7, q256_2)),
					4);
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(sum_p7, p256_3)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_q,
							_mm256_add_epi16(sum_q7, q256_3)),
					4);
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(sum_p7, p256_4)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_q,
							_mm256_add_epi16(sum_q7, q256_4)),
					4);
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(sum_p7, p256_5)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_q,
							_mm256_add_epi16(sum_q7, q256_5)),
					4);
			...
			res_p = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_p,
							_mm256_add_epi16(sum_p7, p256_6)),
					4);
			...
			res_q = _mm256_srli_epi16(
					_mm256_add_epi16(pixelFilter_q,
							_mm256_add_epi16(sum_q7, q256_6)),
					4);
