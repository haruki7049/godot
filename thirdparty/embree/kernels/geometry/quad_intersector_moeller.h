...
struct QuadMIntersectorKMoellerTrumbore : public QuadMIntersectorKMoellerTrumboreBase<M, K, filter> {
	__forceinline QuadMIntersectorKMoellerTrumbore(const vbool<K> &valid, const RayK<K> &ray) : QuadMIntersectorKMoellerTrumboreBase<M, K, filter>(valid, ray) {}
	...
	__forceinline bool occluded1(RayK<K> &ray, size_t k, IntersectContext *context,
		...
		if (MoellerTrumboreIntersector1KTriangleM::intersect1<M, K>(ray, k, v0, v1, v3, vbool<M>(false), epilog))
			return true;
		if (MoellerTrumboreIntersector1KTriangleM::intersect1<M, K>(ray, k, v2, v3, v1, vbool<M>(true), epilog))
			return true;
		return false;
	}
};
...
struct QuadMIntersectorKMoellerTrumbore<4, K, filter> : public QuadMIntersectorKMoellerTrumboreBase<4, K, filter> {
	__forceinline QuadMIntersectorKMoellerTrumbore(const vbool<K> &valid, const RayK<K> &ray) : QuadMIntersectorKMoellerTrumboreBase<4, K, filter>(valid, ray) {}
