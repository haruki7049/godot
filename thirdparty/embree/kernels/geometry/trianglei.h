...
template <>
template <>
__forceinline const vuint<4> &TriangleMi<4>::getVertexOffset<0>() const {
	return v0_;
}
template <>
template <>
__forceinline const vuint<4> &TriangleMi<4>::getVertexOffset<1>() const {
	return v1_;
}
template <>
template <>
__forceinline const vuint<4> &TriangleMi<4>::getVertexOffset<2>() const {
	return v2_;
}
#endif
...
__forceinline void TriangleMi<4>::gather(Vec3vf4 &p0,
	...
	Vec3vf4 a0, a1, a2;
	gather(a0, a1, a2, mesh, scene, itime);
	Vec3vf4 b0, b1, b2;
	gather(b0, b1, b2, mesh, scene, itime + 1);
