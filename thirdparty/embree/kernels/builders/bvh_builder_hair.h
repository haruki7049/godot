...
struct BVHBuilderHair {
	...
	struct Settings {
		/*! default settings */
		Settings() : branchingFactor(2), maxDepth(32), logBlockSize(0), minLeafSize(1), maxLeafSize(7), finished_range_threshold(inf) {}
	...
	class BuilderT {
		...
		BuilderT(Scene *scene,
				...
				: cfg(settings),
				  ...
				  alignedHeuristic(prims),
				  unalignedHeuristic(scene, prims),
				  strandHeuristic(scene, prims) {}
