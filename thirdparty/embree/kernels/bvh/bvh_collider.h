...
class BVHNCollider {
	...
	struct CollideJob {
		...
		CollideJob(NodeRef ref0, const BBox3fa &bounds0, size_t depth0,
				NodeRef ref1, const BBox3fa &bounds1, size_t depth1) : ref0(ref0),
																	   bounds0(bounds0),
																	   depth0(depth0),
																	   ref1(ref1),
																	   bounds1(bounds1),
...
public:
	__forceinline BVHNCollider(Scene *scene0, Scene *scene1, RTCCollideFunc callback, void *userPtr) : scene0(scene0), scene1(scene1), callback(callback), userPtr(userPtr) {}
...
class BVHNColliderUserGeom : public BVHNCollider<N> {
	...
	__forceinline BVHNColliderUserGeom(Scene *scene0, Scene *scene1, RTCCollideFunc callback, void *userPtr) : BVHNCollider<N>(scene0, scene1, callback, userPtr) {}
