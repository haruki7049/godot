...
struct TensorLinearQuadraticBezierSurface {
	...
	__forceinline TensorLinearQuadraticBezierSurface(const TensorLinearQuadraticBezierSurface<V> &curve) : L(curve.L), R(curve.R) {}
	...
	__forceinline TensorLinearQuadraticBezierSurface(const QuadraticBezierCurve<V> &L, const QuadraticBezierCurve<V> &R) : L(L), R(R) {}
...
struct TensorLinearQuadraticBezierSurface<Vec2fa> {
	...
	__forceinline TensorLinearQuadraticBezierSurface(const TensorLinearQuadraticBezierSurface<Vec2fa> &curve) : LR(curve.LR) {}
	...
	__forceinline TensorLinearQuadraticBezierSurface(const QuadraticBezierCurve<vfloat4> &LR) : LR(LR) {}
...
struct TensorLinearCubicBezierSurface {
	...
	__forceinline TensorLinearCubicBezierSurface(const TensorLinearCubicBezierSurface &curve) : L(curve.L), R(curve.R) {}
	...
	__forceinline TensorLinearCubicBezierSurface(const CubicBezierCurve<V> &L, const CubicBezierCurve<V> &R) : L(L), R(R) {}
	...
	__forceinline void split_u(TensorLinearCubicBezierSurface &left, TensorLinearCubicBezierSurface &right, const float u = 0.5f) const {
		CubicBezierCurve<V> L0, L1;
		L.split(L0, L1, u);
		CubicBezierCurve<V> R0, R1;
		R.split(R0, R1, u);
...
struct TensorLinearCubicBezierSurface<Vec2fa> {
	...
	__forceinline TensorLinearCubicBezierSurface(const TensorLinearCubicBezierSurface &curve) : LR(curve.LR) {}
	...
	__forceinline TensorLinearCubicBezierSurface(const CubicBezierCurve<vfloat4> &LR) : LR(LR) {}

	__forceinline TensorLinearCubicBezierSurface(const CubicBezierCurve<Vec2fa> &L, const CubicBezierCurve<Vec2fa> &R) : LR(shuffle<0, 1, 0, 1>(vfloat4(L.v0), vfloat4(R.v0)), shuffle<0, 1, 0, 1>(vfloat4(L.v1), vfloat4(R.v1)), shuffle<0, 1, 0, 1>(vfloat4(L.v2), vfloat4(R.v2)), shuffle<0, 1, 0, 1>(vfloat4(L.v3), vfloat4(R.v3))) {}
	...
	__forceinline void split_u(TensorLinearCubicBezierSurface &left, TensorLinearCubicBezierSurface &right, const float u = 0.5f) const {
		CubicBezierCurve<vfloat4> LR0, LR1;
		LR.split(LR0, LR1, u);
