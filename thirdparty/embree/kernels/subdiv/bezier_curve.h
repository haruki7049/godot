...
struct LinearBezierCurve {
	...
	__forceinline LinearBezierCurve(const LinearBezierCurve &other) : v0(other.v0), v1(other.v1) {}
	...
	__forceinline LinearBezierCurve(const V &v0, const V &v1) : v0(v0), v1(v1) {}
...
template <>
__forceinline bool LinearBezierCurve<Interval1f>::hasRoot() const {
...
struct QuadraticBezierCurve {
	...
	__forceinline QuadraticBezierCurve(const QuadraticBezierCurve &other) : v0(other.v0), v1(other.v1), v2(other.v2) {}
	...
	__forceinline QuadraticBezierCurve(const V &v0, const V &v1, const V &v2) : v0(v0), v1(v1), v2(v2) {}
...
struct CubicBezierCurve {
	...
	__forceinline CubicBezierCurve(const CubicBezierCurve<T1> &other) : v0(other.v0), v1(other.v1), v2(other.v2), v3(other.v3) {}
	...
	__forceinline CubicBezierCurve(const Vertex &v0, const Vertex &v1, const Vertex &v2, const Vertex &v3) : v0(v0), v1(v1), v2(v2), v3(v3) {}
	...
	__forceinline CubicBezierCurve clip(const Interval1f &u1) const {
		Vertex f0, df0;
		eval(u1.lower, f0, df0);
		Vertex f1, df1;
		eval(u1.upper, f1, df1);
...
template <typename Vertex>
using BezierCurveT = CubicBezierCurve<Vertex>;
...
template <>
__forceinline int CubicBezierCurve<float>::maxRoots() const {
	float eps = 1E-4f;
	bool neg0 = v0 <= 0.0f;
	bool zero0 = fabs(v0) < eps;
	bool neg1 = v1 <= 0.0f;
	bool zero1 = fabs(v1) < eps;
	bool neg2 = v2 <= 0.0f;
	bool zero2 = fabs(v2) < eps;
	bool neg3 = v3 <= 0.0f;
	bool zero3 = fabs(v3) < eps;
	return (neg0 != neg1 || zero0) + (neg1 != neg2 || zero1) + (neg2 != neg3 || zero2 || zero3);
}

template <>
__forceinline int CubicBezierCurve<Interval1f>::maxRoots() const {
