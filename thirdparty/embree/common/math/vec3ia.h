...
struct __aligned(16) Vec3ia {
	...
	__forceinline Vec3ia &operator=(const Vec3ia &other) {
		m128 = other.m128;
		return *this;
	}
...
__forceinline Vec3ia abs(const Vec3ia &a) {
...
__forceinline Vec3ia sll(const Vec3ia &a, const int b) {
	return _mm_slli_epi32(a.m128, b);
}
...
__forceinline bool operator==(const Vec3ia &a, const Vec3ia &b) {
	return (_mm_movemask_ps(_mm_castsi128_ps(_mm_cmpeq_epi32(a.m128, b.m128))) & 7) == 7;
}
__forceinline bool operator!=(const Vec3ia &a, const Vec3ia &b) {
	return (_mm_movemask_ps(_mm_castsi128_ps(_mm_cmpeq_epi32(a.m128, b.m128))) & 7) != 7;
}
