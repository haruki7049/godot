...
struct Color4 {
	...
	__forceinline Color4 &operator=(const Color4 &other) {
		m128 = other.m128;
		return *this;
	}
	...
	__forceinline void set(Col3f &d) const {
		d.r = r;
		d.g = g;
		d.b = b;
	}
	__forceinline void set(Col4f &d) const {
		d.r = r;
		d.g = g;
		d.b = b;
		d.a = a;
...
struct Color {
	...
	__forceinline Color &operator=(const Color4 &other) {
		m128 = other.m128;
		return *this;
	}
...
__forceinline const Color sqrt(const Color &a) {
...
__forceinline const Color operator+(const Color &a, const Color &b) {
...
__forceinline const Color operator*(const Color &a, const float b) {
	return a * Color(b);
}
__forceinline const Color operator*(const float a, const Color &b) {
	return Color(a) * b;
}
__forceinline const Color operator/(const Color &a, const Color &b) {
	return a * rcp(b);
...
__forceinline const Color min(const Color &a, const Color &b) {
	return _mm_min_ps(a.m128, b.m128);
}
__forceinline const Color max(const Color &a, const Color &b) {
...
__forceinline const Color operator+=(Color &a, const Color &b) {
	return a = a + b;
}
__forceinline const Color operator-=(Color &a, const Color &b) {
	return a = a - b;
...
__forceinline const Color operator*=(Color &a, const float b) {
	return a = a * b;
}
__forceinline const Color operator/=(Color &a, const float b) {
	return a = a / b;
...
__forceinline float reduce_add(const Color &v) {
	return v.r + v.g + v.b;
}
__forceinline float reduce_mul(const Color &v) {
	return v.r * v.g * v.b;
}
__forceinline float reduce_min(const Color &v) {
	return min(v.r, v.g, v.b);
}
__forceinline float reduce_max(const Color &v) {
...
__forceinline float luminance(const Color &a) {
	return madd(0.212671f, a.r, madd(0.715160f, a.g, 0.072169f * a.b));
}
