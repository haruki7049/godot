...
struct Vec3 {
	...
	__forceinline Vec3(const Vec3<T1> &a) : x(T(a.x)), y(T(a.y)), z(T(a.z)) {}
	template <typename T1>
...
#if defined(__WIN32__) && (_MSC_VER == 1800) // workaround for older VS 2013 compiler
	__forceinline const T &operator[](const size_t axis) const {
		assert(axis < 3);
		return (&x)[axis];
	}
...
template <typename T>
__forceinline Vec3<T> operator+(const Vec3<T> &a) {
...
template <typename T>
__forceinline Vec3<T> abs(const Vec3<T> &a) {
	return Vec3<T>(abs(a.x), abs(a.y), abs(a.z));
}
template <typename T>
__forceinline Vec3<T> rcp(const Vec3<T> &a) {
...
template <typename T>
__forceinline Vec3<T> rcp_safe(const Vec3<T> &a) {
...
template <typename T>
__forceinline Vec3<T> operator*(const T &a, const Vec3<T> &b) {
	return Vec3<T>(a * b.x, a * b.y, a * b.z);
}
template <typename T>
__forceinline Vec3<T> operator*(const Vec3<T> &a, const T &b) {
...
template <typename T>
__forceinline Vec3<T> operator>>(const Vec3<T> &a, const int b) {
	return Vec3<T>(a.x >> b, a.y >> b, a.z >> b);
}
template <typename T>
__forceinline Vec3<T> operator<<(const Vec3<T> &a, const int b) {
...
template <typename T>
__forceinline Vec3<T> madd(const Vec3<T> &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(madd(a.x, b.x, c.x), madd(a.y, b.y, c.y), madd(a.z, b.z, c.z));
}
template <typename T>
__forceinline Vec3<T> msub(const Vec3<T> &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(msub(a.x, b.x, c.x), msub(a.y, b.y, c.y), msub(a.z, b.z, c.z));
}
template <typename T>
__forceinline Vec3<T> nmadd(const Vec3<T> &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(nmadd(a.x, b.x, c.x), nmadd(a.y, b.y, c.y), nmadd(a.z, b.z, c.z));
}
template <typename T>
__forceinline Vec3<T> nmsub(const Vec3<T> &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(nmsub(a.x, b.x, c.x), nmsub(a.y, b.y, c.y), nmsub(a.z, b.z, c.z));
}

template <typename T>
__forceinline Vec3<T> madd(const T &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(madd(a, b.x, c.x), madd(a, b.y, c.y), madd(a, b.z, c.z));
}
template <typename T>
__forceinline Vec3<T> msub(const T &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(msub(a, b.x, c.x), msub(a, b.y, c.y), msub(a, b.z, c.z));
}
template <typename T>
__forceinline Vec3<T> nmadd(const T &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(nmadd(a, b.x, c.x), nmadd(a, b.y, c.y), nmadd(a, b.z, c.z));
}
template <typename T>
__forceinline Vec3<T> nmsub(const T &a, const Vec3<T> &b, const Vec3<T> &c) {
	return Vec3<T>(nmsub(a, b.x, c.x), nmsub(a, b.y, c.y), nmsub(a, b.z, c.z));
}
...
template <typename T>
__forceinline T reduce_add(const Vec3<T> &a) {
	return a.x + a.y + a.z;
}
template <typename T>
__forceinline T reduce_mul(const Vec3<T> &a) {
	return a.x * a.y * a.z;
}
template <typename T>
__forceinline T reduce_min(const Vec3<T> &a) {
	return min(a.x, a.y, a.z);
}
template <typename T>
__forceinline T reduce_max(const Vec3<T> &a) {
...
template <typename T>
__forceinline Vec3<T> shift_right_1(const Vec3<T> &a) {
...
template <typename T>
__forceinline Vec3<T> select(bool s, const Vec3<T> &t, const Vec3<T> &f) {
	return Vec3<T>(select(s, t.x, f.x), select(s, t.y, f.y), select(s, t.z, f.z));
}

template <typename T>
__forceinline Vec3<T> select(const Vec3<bool> &s, const Vec3<T> &t, const Vec3<T> &f) {
	return Vec3<T>(select(s.x, t.x, f.x), select(s.y, t.y, f.y), select(s.z, t.z, f.z));
}

template <typename T>
__forceinline Vec3<T> select(const typename T::Bool &s, const Vec3<T> &t, const Vec3<T> &f) {
	return Vec3<T>(select(s, t.x, f.x), select(s, t.y, f.y), select(s, t.z, f.z));
}
...
template <typename T>
__forceinline int maxDim(const Vec3<T> &a) {
...
template <typename T>
__forceinline Vec3<bool> eq_mask(const Vec3<T> &a, const Vec3<T> &b) {
	return Vec3<bool>(a.x == b.x, a.y == b.y, a.z == b.z);
}
template <typename T>
__forceinline Vec3<bool> neq_mask(const Vec3<T> &a, const Vec3<T> &b) {
	return Vec3<bool>(a.x != b.x, a.y != b.y, a.z != b.z);
}
template <typename T>
__forceinline Vec3<bool> lt_mask(const Vec3<T> &a, const Vec3<T> &b) {
	return Vec3<bool>(a.x < b.x, a.y < b.y, a.z < b.z);
}
template <typename T>
__forceinline Vec3<bool> le_mask(const Vec3<T> &a, const Vec3<T> &b) {
	return Vec3<bool>(a.x <= b.x, a.y <= b.y, a.z <= b.z);
}
template <typename T>
__forceinline Vec3<bool> gt_mask(const Vec3<T> &a, const Vec3<T> &b) {
	return Vec3<bool>(a.x > b.x, a.y > b.y, a.z > b.z);
}
template <typename T>
__forceinline Vec3<bool> ge_mask(const Vec3<T> &a, const Vec3<T> &b) {
	return Vec3<bool>(a.x >= b.x, a.y >= b.y, a.z >= b.z);
}
...
template <typename T>
__forceinline T rcp_length(const Vec3<T> &a) {
	return rsqrt(sqr(a));
}
template <typename T>
...
template <typename T>
__forceinline Vec3<T> stable_triangle_normal(const Vec3<T> &a, const Vec3<T> &b, const Vec3<T> &c) {
...
template <typename T>
__forceinline T sum(const Vec3<T> &a) {
	return a.x + a.y + a.z;
}

template <typename T>
__forceinline T halfArea(const Vec3<T> &d) {
	return madd(d.x, (d.y + d.z), d.y * d.z);
}
template <typename T>
__forceinline T area(const Vec3<T> &d) {
	return 2.0f * halfArea(d);
}

template <typename T>
__forceinline Vec3<T> normalize_safe(const Vec3<T> &a) {
	const T d = dot(a, a);
	return select(d == T(zero), a, a * rsqrt(d));
}

template <typename T>
__forceinline T sqr_point_to_line_distance(const Vec3<T> &P, const Vec3<T> &Q0, const Vec3<T> &Q1) {
...
template <typename T>
__forceinline T sqr_point_to_line_distance(const Vec3<T> &PmQ0, const Vec3<T> &Q1mQ0) {
...
template <typename T>
__forceinline embree_ostream operator<<(embree_ostream cout, const Vec3<T> &a) {
...
template <>
__forceinline Vec3<float>::Vec3(const Vec3fa &a) {
	x = a.x;
	y = a.y;
	z = a.z;
}
...
template <>
__forceinline Vec3<vfloat4>::Vec3(const Vec3fa &a) {
	const vfloat4 v = vfloat4(a.m128);
	x = shuffle<0, 0, 0, 0>(v);
	y = shuffle<1, 1, 1, 1>(v);
	z = shuffle<2, 2, 2, 2>(v);
}
...
#if defined(__AVX512F__)
template <>
__forceinline Vec3<vfloat16>::Vec3(const Vec3fa &a) : x(a.x), y(a.y), z(a.z) {}
#endif
} // namespace embree
