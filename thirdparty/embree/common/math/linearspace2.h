...
struct LinearSpace2 {
	...
	__forceinline LinearSpace2(const LinearSpace2 &other) {
		vx = other.vx;
		vy = other.vy;
	}
	__forceinline LinearSpace2 &operator=(const LinearSpace2 &other) {
		vx = other.vx;
		vy = other.vy;
		return *this;
	}
	...
	__forceinline LinearSpace2(const LinearSpace2<L1> &s) : vx(s.vx), vy(s.vy) {}

	/*! matrix construction from column vectors */
	__forceinline LinearSpace2(const Vector &vx, const Vector &vy) : vx(vx), vy(vy) {}

	/*! matrix construction from row mayor data */
	__forceinline LinearSpace2(const Scalar &m00, const Scalar &m01,
			const Scalar &m10, const Scalar &m11) : vx(m00, m10),
													vy(m01, m11) {}
...
template <typename T>
__forceinline LinearSpace2<T> operator-(const LinearSpace2<T> &a) {
	return LinearSpace2<T>(-a.vx, -a.vy);
}
template <typename T>
__forceinline LinearSpace2<T> operator+(const LinearSpace2<T> &a) {
	return LinearSpace2<T>(+a.vx, +a.vy);
...
template <typename T>
__forceinline LinearSpace2<T> rcp(const LinearSpace2<T> &a) {
	return a.inverse();
}
...
template <typename T>
__forceinline LinearSpace2<T> operator+(const LinearSpace2<T> &a, const LinearSpace2<T> &b) {
...
template <typename T>
__forceinline LinearSpace2<T> operator*(const typename T::Scalar &a, const LinearSpace2<T> &b) {
	return LinearSpace2<T>(a * b.vx, a * b.vy);
}
template <typename T>
__forceinline T operator*(const LinearSpace2<T> &a, const T &b) {
...
template <typename T>
__forceinline LinearSpace2<T> operator/(const LinearSpace2<T> &a, const typename T::Scalar &b) {
...
template <typename T>
__forceinline LinearSpace2<T> &operator*=(LinearSpace2<T> &a, const LinearSpace2<T> &b) {
	return a = a * b;
}
template <typename T>
__forceinline LinearSpace2<T> &operator/=(LinearSpace2<T> &a, const LinearSpace2<T> &b) {
...
template <typename T>
__forceinline bool operator==(const LinearSpace2<T> &a, const LinearSpace2<T> &b) {
...
template <typename T>
static embree_ostream operator<<(embree_ostream cout, const LinearSpace2<T> &m) {
