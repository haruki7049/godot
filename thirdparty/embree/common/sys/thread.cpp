...
public:
	ThreadStartupData(thread_func f, void *arg) : f(f), arg(arg) {}
...
struct ThreadStartupData {
public:
	ThreadStartupData(thread_func f, void *arg, int affinity) : f(f), arg(arg), affinity(affinity) {}
