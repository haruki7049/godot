...
struct vboolf<4> {
	...
	__forceinline vboolf4 &operator=(const vboolf4 &f) {
		v = f.v;
		return *this;
	}
	...
	__forceinline vboolf(bool a, bool b, bool c, bool d) : v((__mmask8)((int(d) << 3) | (int(c) << 2) | (int(b) << 1) | int(a))) {}
...
__forceinline int all(const vboolf4 &a) {
	return a.v == 0xf;
}
__forceinline int any(const vboolf4 &a) {
	return _mm512_kortestz(a, a) == 0;
}
__forceinline int none(const vboolf4 &a) {
	return _mm512_kortestz(a, a) != 0;
}

__forceinline int all(const vboolf4 &valid, const vboolf4 &b) {
	return all((!valid) | b);
}
__forceinline int any(const vboolf4 &valid, const vboolf4 &b) {
	return any(valid & b);
}
__forceinline int none(const vboolf4 &valid, const vboolf4 &b) {
	return none(valid & b);
}
...
__forceinline unsigned int toInt(const vboolf4 &a) {
