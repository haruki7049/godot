...
__forceinline vboolf4 eq(const vboolf4 &mask, const vuint4 &a, const vuint4 &b) {
	return _mm_mask_cmp_epu32_mask(mask, a, b, _MM_CMPINT_EQ);
}
__forceinline vboolf4 ne(const vboolf4 &mask, const vuint4 &a, const vuint4 &b) {
	return _mm_mask_cmp_epu32_mask(mask, a, b, _MM_CMPINT_NE);
}
...
#if defined(__SSE3__)
template <>
__forceinline vuint4 shuffle<0, 0, 2, 2>(const vuint4 &v) {
	return _mm_castps_si128(_mm_moveldup_ps(_mm_castsi128_ps(v)));
}
template <>
__forceinline vuint4 shuffle<1, 1, 3, 3>(const vuint4 &v) {
	return _mm_castps_si128(_mm_movehdup_ps(_mm_castsi128_ps(v)));
}
template <>
__forceinline vuint4 shuffle<0, 1, 0, 1>(const vuint4 &v) {
...
#if defined(__SSE4_1__)
template <int src>
__forceinline unsigned int extract(const vuint4 &b) {
...
template <>
__forceinline unsigned int extract<0>(const vuint4 &b) {
