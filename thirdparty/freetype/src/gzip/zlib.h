...
ZEXTERN(int)
inflateReset OF((z_streamp strm));
/*
...
ZEXTERN(uLong)
adler32 OF((uLong adler, const Bytef *buf, uInt len));
 ...
 */
ZEXTERN(int)
inflateInit2_ OF((z_streamp strm, int windowBits,
