...
typedef FT_Error (*FT_Glyph_InitFunc)(FT_Glyph glyph,
		FT_GlyphSlot slot);
...
typedef FT_Error (*FT_Glyph_CopyFunc)(FT_Glyph source,
		FT_Glyph target);

typedef FT_Error (*FT_Glyph_PrepareFunc)(FT_Glyph glyph,
		FT_GlyphSlot slot);
