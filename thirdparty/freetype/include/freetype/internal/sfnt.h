 ...
 */
typedef FT_Error (*TT_Load_Any_Func)(TT_Face face,
		FT_ULong tag,
		FT_Long offset,
		FT_Byte *buffer,
		FT_ULong *length);
 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Get_PS_Name_Func)(TT_Face face,
		FT_UInt idx,
		FT_String **PSname);
 ...
 */
typedef void (*TT_Get_Metrics_Func)(TT_Face face,
		FT_Bool vertical,
		FT_UInt gindex,
		FT_Short *abearing,
		FT_UShort *aadvance);
 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Set_Palette_Func)(TT_Face face,
		FT_UInt idx);
 ...
 */
typedef FT_Bool (*TT_Get_Colr_Layer_Func)(TT_Face face,
		FT_UInt base_glyph,
 ...
 */
typedef FT_Error (*TT_Load_Table_Func)(TT_Face face,
		FT_Stream stream);
