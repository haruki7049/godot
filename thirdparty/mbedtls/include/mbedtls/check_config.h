...
#if defined(MBEDTLS_ECP_C) && (!defined(MBEDTLS_BIGNUM_C) || (!defined(MBEDTLS_ECP_DP_SECP192R1_ENABLED) &&         \
...
#if defined(MBEDTLS_SSL_TLS_C) && (defined(MBEDTLS_SSL_PROTO_SSL3) && \
										  defined(MBEDTLS_SSL_PROTO_TLS1_2) && (!defined(MBEDTLS_SSL_PROTO_TLS1) || !defined(MBEDTLS_SSL_PROTO_TLS1_1)))
#error "Illegal protocol selection"
#endif
