...
struct error : public std::exception {
	...
	error(mkldnn_status_t astatus, const char *amessage) : status(astatus), message(amessage) {}
...
public:
	...
	/// @param md Memory descriptor.
	/// @param aengine Engine.
	memory(const desc &md, const engine &aengine) : memory(md, aengine, MKLDNN_NATIVE_HANDLE_ALLOCATE) {}
...
struct sum : public primitive {
	struct primitive_desc : public handle<mkldnn_primitive_desc_t> {
		...
		primitive_desc(const memory::desc &dst,
				...
				const std::vector<memory::desc> &srcs, const engine &aengine) {
			error::wrap_c_api(scales.size() == srcs.size() ? mkldnn_success : mkldnn_invalid_arguments,
...
struct primitive_desc : public handle<mkldnn_primitive_desc_t> {
	...
	bool next_impl() {
		mkldnn_status_t status = mkldnn_primitive_desc_iterator_next(
				pd_iterator.get());
		if (status == mkldnn_iterator_ends)
			return false;
...
struct convolution_forward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e) : mkldnn::primitive_desc(&desc.data, nullptr, e, nullptr) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e) : mkldnn::primitive_desc(&desc.data, &attr, e, nullptr) {}
...
struct convolution_backward_data : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const convolution_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const convolution_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct deconvolution_backward_data : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const deconvolution_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const deconvolution_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct lrn_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const lrn_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const lrn_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct pooling_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const pooling_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const pooling_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct eltwise_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const eltwise_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const eltwise_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct softmax_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const softmax_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const softmax_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct batch_normalization_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const batch_normalization_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const batch_normalization_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct inner_product_backward_data : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const inner_product_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const inner_product_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct rnn_cell {
	struct desc {
		...
		algorithm get_activation() const { return algorithm(c_rnn_cell_.activation_kind); }
...
struct rnn_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const rnn_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}

		primitive_desc(const desc &desc, const primitive_attr &attr, const engine &e,
				const rnn_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, &attr, e, hint_fwd_pd.get()) {}
...
struct shuffle_backward : public primitive {
	...
	struct primitive_desc : public mkldnn::primitive_desc {
		primitive_desc(const desc &desc, const engine &e,
				const shuffle_forward::primitive_desc &hint_fwd_pd) : mkldnn::primitive_desc(&desc.data, nullptr, e, hint_fwd_pd.get()) {}
