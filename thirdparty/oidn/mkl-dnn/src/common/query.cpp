...
const memory_desc_t *mkldnn_primitive_desc_query_md(
	...
	bool args_ok = true && primitive_desc != nullptr && (what & query::some_md) == query::some_md && what != query::some_md && mkldnn_primitive_desc_query(primitive_desc, what, index, &res_md) == success;
...
int mkldnn_primitive_desc_query_s32(const primitive_desc_t *primitive_desc,
	...
	int res_s32;
	bool args_ok = primitive_desc != nullptr && one_of(what, query::num_of_inputs_s32, query::num_of_outputs_s32) && mkldnn_primitive_desc_query(primitive_desc, what, index, &res_s32) == success;
