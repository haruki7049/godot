...
#define DECL_CTOR_AND_CONVERTERS(c_type, name)                                               \
	...
	static op_desc_t *convert_from_c(c_type *_) { return reinterpret_cast<op_desc_t *>(_); } \
	static const op_desc_t *convert_from_c(const c_type *_) { return reinterpret_cast<const op_desc_t *>(_); }
