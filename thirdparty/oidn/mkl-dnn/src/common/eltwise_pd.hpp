...
struct eltwise_pd_t : public primitive_desc_t {
	...
	eltwise_pd_t(mkldnn::impl::engine_t *engine,
			...
			const eltwise_fwd_pd_t *hint_fwd_pd) : primitive_desc_t(engine, attr, base_pkind),
												   desc_(*adesc),
...
struct eltwise_fwd_pd_t : public eltwise_pd_t {
	...
	eltwise_fwd_pd_t(mkldnn::impl::engine_t *engine,
			const eltwise_desc_t *adesc,
			const primitive_attr_t *attr,
			const eltwise_fwd_pd_t *hint_fwd_pd) : eltwise_pd_t(engine, adesc, attr, hint_fwd_pd) {}
	...
	bool is_zero_preserved() const { return math::eltwise_fwd_preserves_zero(desc_.alg_kind); }
};
