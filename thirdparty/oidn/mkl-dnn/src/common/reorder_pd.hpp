...
struct reorder_pd_t : public primitive_desc_t {
	reorder_pd_t(engine_t *engine, const primitive_attr_t *attr,
			...
			engine_t *dst_engine, const memory_desc_t *dst_md) : primitive_desc_t(engine, attr, primitive_kind::reorder),
	...
	virtual mkldnn::impl::engine_t *scratchpad_engine() const override { return scratchpad_engine_; }
