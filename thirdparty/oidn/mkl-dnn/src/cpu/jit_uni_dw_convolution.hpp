...
struct _jit_uni_dw_convolution_fwd_t : public cpu_primitive_t {
	...
	_jit_uni_dw_convolution_fwd_t(const pd_t *apd) : cpu_primitive_t(apd) { kernel_ = new jit_uni_dw_conv_fwd_kernel_f32<isa>(pd()->jcp_); }
...
struct _jit_uni_dw_convolution_bwd_data_t : public cpu_primitive_t {
	...
	_jit_uni_dw_convolution_bwd_data_t(const pd_t *apd) : cpu_primitive_t(apd) { kernel_ = new jit_uni_dw_conv_bwd_data_kernel_f32<isa>(pd()->jcp_); }
...
struct _jit_uni_dw_convolution_bwd_weights_t : public cpu_primitive_t {
	struct pd_t : public cpu_convolution_bwd_weights_pd_t {
		...
		status_t init() {
			...
			const int max_threads = mkldnn_in_parallel() ? 1 : mkldnn_get_max_threads();
