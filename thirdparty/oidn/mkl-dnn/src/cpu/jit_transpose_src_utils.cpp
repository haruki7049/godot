...
void jit_trans_iw_ic_t::transpose(int nrows, int l_pad, int r_pad,
	...
	auto pf_src_t0 = [=](int i) {
		if (enable_prefetch)
			prefetcht0(EVEX_compress_addr(reg_src,
	...
	auto pf_tr_src_t0 = [=](int i) {
		...
		if (enable_prefetch)
			prefetcht0(EVEX_compress_addr(reg_tr_src, offset));
		if (enable_prefetch)
	...
	auto pf_src_t1 = [=](int i) {
		if (enable_prefetch)
			prefetcht1(EVEX_compress_addr(reg_src_prf,
					i * src_stride));
	};

	auto pf_tr_src_t1 = [=](int i) {
		if (enable_prefetch)
			prefetchwt1(EVEX_compress_addr(reg_tr_src_prf,
					i * tr_src_stride));
	};
...
void jit_trans_iw_ic_int16_t::generate() {
	...
	alignas(64) static constexpr const int64_t idx2[8] = { 1, 0, 3, 2, 5, 4, 7, 6 };
	alignas(64) static constexpr const int32_t idx3[16] = { 1, 0, 3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12, 15, 14 };
	alignas(64) static constexpr const int32_t idx4[16] = { 8, 10, 12, 14, 0, 2, 4, 6, 9, 11, 13, 15, 1, 3, 5, 7 };
	alignas(64) static constexpr const int32_t idx5[16] = { 8, 10, 12, 14, 0, 2, 4, 6, 9, 11, 13, 15, 1, 3, 5, 7 };
...
void jit_trans_ow_oc_t::generate() {
	...
	alignas(64) static constexpr const int64_t idx1[8] = { 4, 5, 0, 1, 6, 7, 2, 3 };
...
alignas(64) static constexpr const int64_t idx1[8] = { 2, 3, 0, 1, 6, 7, 4, 5 };
alignas(64) static constexpr const int32_t idxP[16] = { 0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15 };
