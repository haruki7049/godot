...
struct jit_avx2_1x1_convolution_fwd_t : public cpu_primitive_t {
	...
	protected:
		bool set_default_formats() {
			...
			auto wei_tag = with_groups() ? utils::pick(ndims() - 3, gOIw8i8o, gOIhw8i8o) : utils::pick(ndims() - 3, OIw8i8o, OIhw8i8o);
	...
	jit_avx2_1x1_convolution_fwd_t(const pd_t *apd) : cpu_primitive_t(apd), kernel_(nullptr), rtus_driver_(nullptr) {
...
struct jit_avx2_1x1_convolution_bwd_data_t : public cpu_primitive_t {
	...
	protected:
		bool set_default_formats() {
			...
			auto dat_tag = utils::pick(ndims() - 3, nCw8c, nChw8c, nCdhw8c);
			auto wei_tag = with_groups() ? utils::pick(ndims() - 3, gOIw8o8i, gOIhw8o8i) : utils::pick(ndims() - 3, OIw8o8i, OIhw8o8i);
	...
	jit_avx2_1x1_convolution_bwd_data_t(const pd_t *apd) : cpu_primitive_t(apd), kernel_(nullptr), rtus_driver_(nullptr) {
		kernel_ = new jit_avx2_1x1_conv_kernel_f32(pd()->jcp_, *pd()->attr());
		init_rtus_driver<avx2>(this);
	}
...
struct jit_avx2_1x1_convolution_bwd_weights_t : public cpu_primitive_t {
	...
	private:
		void init_balancers() {
			...
			const int job_size = nb_oc_blocking * nb_ic_blocking * ic_block * oc_block;
