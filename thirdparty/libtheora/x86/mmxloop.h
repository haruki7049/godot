...
#define OC_LOOP_FILTER8_MMX                                                                                                                                            \
	...
	"pxor %%mm6,%%mm6\n\t"                                                                                                                                             \
	"pxor %%mm7,%%mm4\n\t"                                                                                                                                             \
	"packuswb %%mm3,%%mm1\n\t" /*Now compute lflim of -mm4 cf. Section 7.10 of the sepc.*/ /*There's no unsigned byte+signed byte with unsigned saturation op code, so \
	...
	"movq %%mm4,%%mm5\n\t"                                                                                                                                             \
	"pand %%mm6,%%mm4\n\t"                                                                                                                                             \
	"pandn %%mm5,%%mm6\n\t" /*mm1={b0+lflim(R_0,L),...,b7+lflim(R_7,L)}*/ /*mm2={c0-lflim(R_0,L),...,c7-lflim(R_7,L)}*/                                                \
	"paddusb %%mm4,%%mm1\n\t"                                                                                                                                          \
	"psubusb %%mm4,%%mm2\n\t"                                                                                                                                          \
	"psubusb %%mm6,%%mm1\n\t"                                                                                                                                          \
	"paddusb %%mm6,%%mm2\n\t"
...
#define OC_LOOP_FILTER_V_MMX(_pix, _ystride, _ll)                                                 \
	do {                                                                                          \
		...
		__asm__ __volatile__(/*mm0={a0,...,a7}*/                                                  \
				...
				"movq (%[pix],%[ystride],2),%%mm2\n\t" OC_LOOP_FILTER8_MMX /*Write it back out.*/ \
