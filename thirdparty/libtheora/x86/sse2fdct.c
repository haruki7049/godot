...
#define OC_FDCT8x8                                                                                               \
	...
	"paddw %%xmm6,%%xmm1\n\t" /*xmm5=t2'=t2+t5*/                                                                 \
	"paddw %%xmm2,%%xmm5\n\t" /*xmm4=t3'=t3+t4*/                                                                 \
	"paddw %%xmm3,%%xmm4\n\t" /*xmm2,3,6,7 are now free.*/ /*Stage 2:*/                                          \
	"movdqa %%xmm0,%%xmm3\n\t"                                                                                   \
	"mov $0x5A806A0A,%[a]\n\t"                                                                                   \
	"movdqa %%xmm1,%%xmm2\n\t"                                                                                   \
	"movd %[a],%%xmm13\n\t"                                                                                      \
	...
	"paddw %%xmm0,%%xmm4\n\t" /*xmm1=t1''=t1'+t2'*/                                                              \
	"paddw %%xmm5,%%xmm1\n\t" /*xmm6=t6''=t6'+t5'*/                                                              \
	"paddw %%xmm9,%%xmm6\n\t" /*xmm0,xmm5,xmm9 are now free.*/ /*Stage 3:*/ /*xmm10:xmm5=t5''*27146+0xB500       \
																			  xmm0=t5''*/                        \
	"movdqa %%xmm10,%%xmm5\n\t"                                                                                  \
	"movdqa %%xmm10,%%xmm0\n\t"                                                                                  \
	...
	"psraw $1,%%xmm0\n\t" /*xmm5=t5'''=t4'-s*/                                                                   \
	"psubw %%xmm0,%%xmm5\n\t" /*xmm8=t4''=t4'+s*/                                                                \
	"paddw %%xmm0,%%xmm8\n\t" /*xmm0,xmm7,xmm9,xmm10 are free.*/ /*xmm7:xmm9=t6''*27146+0xB500*/                 \
	"movdqa %%xmm6,%%xmm7\n\t"                                                                                   \
	"movdqa %%xmm6,%%xmm9\n\t"                                                                                   \
	...
	"psraw $1,%%xmm9\n\t" /*xmm7=t6'''=t7'-s*/                                                                   \
	"psubw %%xmm9,%%xmm7\n\t" /*xmm9=t7''=t7'+s*/                                                                \
	"paddw %%xmm11,%%xmm9\n\t" /*xmm0,xmm6,xmm10,xmm11 are free.*/ /*Stage 4:*/ /*xmm10:xmm0=t1''*27146+0xB500*/ \
	"movdqa %%xmm1,%%xmm0\n\t"                                                                                   \
	"movdqa %%xmm1,%%xmm10\n\t"                                                                                  \
	...
	"paddw %%xmm6,%%xmm0\n\t" /*xmm4=_y[4]=v=r-u*/                                                               \
	"pshufd $00,%%xmm13,%%xmm13\n\t"                                                                             \
	"psubw %%xmm0,%%xmm4\n\t" /*xmm1,xmm6,xmm10,xmm11 are free.*/ /*xmm6:xmm10=60547*t3''+0x6CB7*/               \
	"movdqa %%xmm3,%%xmm10\n\t"                                                                                  \
	"movdqa %%xmm3,%%xmm6\n\t"                                                                                   \
	...
	"psubw %%xmm14,%%xmm10\n\t"                                                                                  \
	"pshufd $00,%%xmm13,%%xmm13\n\t"                                                                             \
	"paddw %%xmm10,%%xmm6\n\t " /*xmm1,xmm3,xmm10,xmm11 are free.*/ /*xmm11:xmm10=54491*t5'''+0x0E3D*/           \
	"movdqa %%xmm5,%%xmm10\n\t"                                                                                  \
	"movdqa %%xmm5,%%xmm11\n\t"                                                                                  \
	...
	"psubw %%xmm14,%%xmm1\n\t"                                                                                   \
	"pshufd $00,%%xmm13,%%xmm13\n\t"                                                                             \
	"paddw %%xmm1,%%xmm3\n\t " /*xmm1,xmm7,xmm10,xmm11 are free.*/ /*xmm11:xmm10=64277*t7''+0x7B1B*/             \
	"movdqa %%xmm9,%%xmm10\n\t"                                                                                  \
	"movdqa %%xmm9,%%xmm11\n\t"                                                                                  \
