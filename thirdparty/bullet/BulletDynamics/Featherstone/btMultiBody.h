...
public:
  ...
  */
	...
	void fillContactJacobianMultiDof(int link,
		...
		fillConstraintJacobianMultiDof(link, contact_point, btVector3(0, 0, 0), normal, jac, scratch_r, scratch_v, scratch_m);
	}
