...
public:
	...
	btJacobianEntry(
			...
			const btScalar massInvB) : m_linearJointAxis(jointAxis) {
	...
	btJacobianEntry(const btVector3 &jointAxis,
			...
			const btMatrix3x3 &world2B,
			const btVector3 &inertiaInvA,
			const btVector3 &inertiaInvB) : m_linearJointAxis(btVector3(btScalar(0.), btScalar(0.), btScalar(0.))) {
	...
	btJacobianEntry(
			...
			const btVector3 &jointAxis,
			const btVector3 &inertiaInvA,
			const btScalar massInvA) : m_linearJointAxis(jointAxis) {
