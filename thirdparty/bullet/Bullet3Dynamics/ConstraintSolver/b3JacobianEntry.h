...
public:
	...
	b3JacobianEntry(
			...
			const b3Scalar massInvB) : m_linearJointAxis(jointAxis) {
	...
	b3JacobianEntry(const b3Vector3 &jointAxis,
			...
			const b3Matrix3x3 &world2B,
			const b3Vector3 &inertiaInvA,
			const b3Vector3 &inertiaInvB) : m_linearJointAxis(b3MakeVector3(b3Scalar(0.), b3Scalar(0.), b3Scalar(0.))) {
	...
	b3JacobianEntry(
			...
			const b3Vector3 &jointAxis,
			const b3Vector3 &inertiaInvA,
			const b3Scalar massInvA) : m_linearJointAxis(jointAxis) {
