...
struct btPerturbedContactResult : public btManifoldResult {
	...
	btPerturbedContactResult(btManifoldResult *originalResult, const btTransform &transformA, const btTransform &transformB, const btTransform &unPerturbedTransform, bool perturbA, btIDebugDraw *debugDrawer) : m_originalManifoldResult(originalResult),
...

	{
		...
		if (min0->isPolyhedral() && min1->isPolyhedral()) {
			...
			struct btWithoutMarginResult : public btDiscreteCollisionDetectorInterface::Result {
				...
				bool m_foundResult;
				btWithoutMarginResult(btDiscreteCollisionDetectorInterface::Result *result, btScalar marginOnA, btScalar marginOnB) : m_originalResult(result),
