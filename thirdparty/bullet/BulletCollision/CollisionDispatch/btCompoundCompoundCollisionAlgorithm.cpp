...
btCompoundCompoundCollisionAlgorithm::btCompoundCompoundCollisionAlgorithm(const btCollisionAlgorithmConstructionInfo &ci, const btCollisionObjectWrapper *body0Wrap, const btCollisionObjectWrapper *body1Wrap, bool isSwapped) : btCompoundCollisionAlgorithm(ci, body0Wrap, body1Wrap, isSwapped) {
...
struct btCompoundCompoundLeafCallback : btDbvt::ICollide {
	...
	btCompoundCompoundLeafCallback(const btCollisionObjectWrapper *compound1ObjWrap,
			...
			btPersistentManifold *sharedManifold) : m_numOverlapPairs(0),
