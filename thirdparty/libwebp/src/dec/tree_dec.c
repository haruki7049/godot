...
static void ParseIntraMode(VP8BitReader *const br,
	...
	if (dec->segment_hdr_.update_map_) {
		...
		block->segment_ = !VP8GetBit(br, dec->proba_.segments_[0], "segments") ? VP8GetBit(br, dec->proba_.segments_[1], "segments") : VP8GetBit(br, dec->proba_.segments_[2], "segments") + 2;
	} else {
				...
				ymode = !VP8GetBit(br, prob[0], "pred-modes") ? B_DC_PRED :
						...
						!VP8GetBit(br, prob[3], "pred-modes") ?
																(!VP8GetBit(br, prob[4], "pred-modes") ? B_HE_PRED :
																										 (!VP8GetBit(br, prob[5], "pred-modes") ? B_RD_PRED : B_VR_PRED)) :
																(!VP8GetBit(br, prob[6], "pred-modes") ? B_LD_PRED :
																										 (!VP8GetBit(br, prob[7], "pred-modes") ? B_VL_PRED :
																																				  (!VP8GetBit(br, prob[8], "pred-modes") ? B_HD_PRED : B_HU_PRED)));
#endif // USE_GENERIC_TREE
				top[x] = ymode;
			}
	...
	block->uvmode_ = !VP8GetBit(br, 142, "pred-modes-uv") ? DC_PRED : !VP8GetBit(br, 114, "pred-modes-uv") ? V_PRED :
