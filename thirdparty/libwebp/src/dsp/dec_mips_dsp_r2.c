	...
	__asm__ volatile(
					...
					ADD_SUB_HALVES(temp3, temp4, temp1, temp2)
							LOAD_IN_X2(temp1, temp2, 8, 10)
									MUL_SHIFT_SUM(temp7, temp8, temp9, temp10, temp11, temp12, temp13, temp14,
											...
											INSERT_HALF_X2(temp8, temp7, temp10, temp9) "ulw              %[temp17],  4(%[in])                 \n\t"
			...
			SRA_16(temp9, temp10, temp11, temp12, temp1, temp2, temp5, temp6)
					INSERT_HALF_X2(temp1, temp6, temp5, temp2)
							SRA_16(temp13, temp14, temp15, temp16, temp3, temp4, temp17, temp8) "repl.ph          %[temp2],   0x4                      \n\t" INSERT_HALF_X2(temp3, temp8, temp17, temp4) "addq.ph          %[temp1],   %[temp1],  %[temp2]      \n\t"
...
static void RD4(uint8_t *dst) { // Down-right
	...
	__asm__ volatile(
			LOAD_4_BYTES(temp0, temp1, temp2, temp3, -1, 0, -1, 1, -1, 2, -1, 3, dst) "ulw            %[temp7],   -1-" XSTR(BPS) "(%[dst])       \n\t"
...
static void LD4(uint8_t *dst) { // Down-Left
	...
	__asm__ volatile(
			LOAD_8_BYTES(temp0, temp1, -1, 4, -1, dst) "preceu.ph.qbl   %[temp2],    %[temp0]                     \n\t"
	...
	__asm__ volatile(
			LOAD_8_BYTES(temp0, temp1, -1, 4, -1, dst)
					LOAD_4_BYTES(temp2, temp3, temp4, temp5, -1, 0, -1, 1, -1, 2, -1, 3, dst)
							LOAD_4_BYTES(temp6, temp7, temp8, temp9, -1, 4, -1, 5, -1, 6, -1, 7, dst) "raddu.w.qb   %[temp0],   %[temp0]                   \n\t"
																									  "raddu.w.qb   %[temp1],   %[temp1]                   \n\t"
...
static void DC8uvNoLeft(uint8_t *dst) { // DC with no left samples
	int temp0, temp1;
	__asm__ volatile(
			LOAD_8_BYTES(temp0, temp1, -1, 4, -1, dst) "raddu.w.qb   %[temp0],   %[temp0]                   \n\t"
													   "raddu.w.qb   %[temp1],   %[temp1]                   \n\t"
													   "addu         %[temp0],   %[temp0],    %[temp1]      \n\t"
													   "shra_r.w     %[temp0],   %[temp0],    3             \n\t"
													   "replv.qb     %[temp0],   %[temp0]                   \n\t" STORE_8_BYTES(temp0, temp0, 0, 4, 0, dst)
...
static void DC8uvNoTop(uint8_t *dst) { // DC with no top samples
	...
	__asm__ volatile(
			LOAD_4_BYTES(temp2, temp3, temp4, temp5, -1, 0, -1, 1, -1, 2, -1, 3, dst)
					LOAD_4_BYTES(temp6, temp7, temp8, temp1, -1, 4, -1, 5, -1, 6, -1, 7, dst) "addu         %[temp2],   %[temp2],    %[temp3]      \n\t"
																							  "addu         %[temp4],   %[temp4],    %[temp5]      \n\t"
																							  "addu         %[temp6],   %[temp6],    %[temp7]      \n\t"
